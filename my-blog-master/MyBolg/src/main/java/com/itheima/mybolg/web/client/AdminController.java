...
import com.itheima.mybolg.model.ResponseData.ArticleResponseData;
...
import com.itheima.mybolg.service.impl.ArticleServiceImpl;
import com.itheima.mybolg.service.impl.CommentServiceImpl;
...
public ArticleResponseData delete(@RequestParam int id) {
    ...
    @ResponseBody
    public ArticleResponseData commentDelete(@RequestParam int id) {
